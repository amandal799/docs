...
Once your institute is set up, here are the common tasks you'll perform regularly:

<CardGroup cols={2}>
  <Card title="Schedule Lectures" icon="calendar" href="/lectures/schedule-lecture">
    Set up your institute's timetable. Students and teachers receive automatic notifications for scheduled lectures.
  </Card>

  <Card title="Upload Answer Sheets" icon="file-arrow-up" href="/tests-evaluation/upload-answer-sheets">
    After tests are conducted, scan and upload handwritten answer sheets. AI evaluates them in 24 hours.
  </Card>

  <Card title="View Analytics" icon="chart-line" href="/getting-started/for-admin#understanding-your-analytics">
    Track performance across students, batches, centers, and subjects. Identify weak areas and trends over time.
  </Card>

  <Card title="Make Announcements" icon="megaphone" href="/notice-board/make-announcement">
    Communicate with students and teachers. Target announcements to specific centers, courses, or batches.
  </Card>

  <Card title="Manage Batches" icon="users-gear" href="/batches/create-batch">
    Add or remove students from batches, update batch details, or create new batches as your institute grows.
  </Card>

  <Card title="Manage Users" icon="user-pen" href="/students/onboard-single-student">
    Onboard new students, teachers, or admins. Deactivate or delete accounts when needed.
  </Card>

  <Card title="Manage Centers & Courses" icon="building-columns" href="/centres-branches/onboard-center">
    Add new centers as you expand. Create new courses or modify existing ones.
  </Card>

  <Card title="Share Test Results" icon="share-nodes" href="/tests-evaluation/share-test-results">
    Publish evaluated test results to students with detailed feedback and performance insights.
  </Card>
</CardGroup>
...
Need to jump to a specific task? Here are the most common workflows:
...
<CardGroup cols={3}>
  ...
  <Card title="Manage Courses" icon="bullseye" href="/courses-targets/create-course">
    Add or edit courses and subjects
  </Card>
